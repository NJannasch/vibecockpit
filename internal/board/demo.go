			...
			Tasks: []Task{
				{
					...
					ClaimedBy: "claude-code", Session: "ses_abc123",
					Cost: "$8.50", Completed: "2026-04-30T14:30:00Z",
				...
				},
				{
					...
					ClaimedBy: "claude-code", Session: "ses_def456",
				...
				},
				{
					...
					Cost: "$2.10", Started: "2026-04-29T14:00:00Z",
				...
				},
				{
					...
					Tool: "codex", Model: "openai/gpt-5.4",
					Cost: "$0.90", Completed: "2026-04-28T18:00:00Z",
