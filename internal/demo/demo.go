	...
	return &DemoProvider{
		sessions: []provider.Session{
			// Claude Code — active sessions
			{
				...
				Modified: now.Add(-12 * time.Minute), IsActive: true, ActivePID: 10001,
			},
			{
				...
				Modified: now.Add(-2 * h), IsActive: true, ActivePID: 10002,
			},
			{
			...
			// Codex CLI
			{
				...
				Modified: now.Add(-45 * time.Minute), IsActive: true, ActivePID: 10003,
			},
			{
			...
			},
			{
				...
				Modified: now.Add(-20 * time.Minute), IsActive: true, ActivePID: 10004,
			},
		},
	}
}
